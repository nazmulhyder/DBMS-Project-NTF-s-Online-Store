						...
						while($row_pro = mysqli_fetch_array($query_pro)){
							...
							echo "
								<div id='product_details'>
									<div class='pro_img'><img src='admin_area/$pro_image'/></div>
									<div class='title_price'><h3>$pro_title</h3>
									<p><b>Price: $".number_format("$pro_price",2)."</b></p>
									</div>
									<div class='pro_description'><p>$pro_desc</p></div>
									<div id='button'>
