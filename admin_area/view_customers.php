		...
		<div class="main_wrapper">
			...
			<div class="content_section">
				<div class="main_content">
					<h2 style="text-align:center;color:#9e005d;margin-top:15px;text-decoration:underline;">View All Customer's Here</h2>
					<table border="1" width="700" align="center" style="margin:25px auto;text-align:center;">
						...
						<?php
							...
							<tr>
								<td><?php echo $i; ?></td>
								<td><?php echo "<img src='../customer/$customer_image' width='120' height='120'/>";?></td>
								<td><?php echo $row['customer_name']."<br/>";?></td>
								<td><?php echo $row['customer_email']."<br/>";?></td>
								<td><a href="delete_customer.php?delete_c_id=<?php echo $row['customer_id'];?>" style="text-decoration:none;"><input type="button" value="Delete" style="background:#9e005d;color:white;padding:5px 10px;font-size:12px;"/></a></td>
							</tr>
							<?php
							$i++;
							}
								...
								?>
									<tr>
										<td colspan="6" style="text-align:center;color:#9e005d;">There are no Customer to view.</td>
									</tr>
								<?php
							}
						?>
