		...
		<div class="main_wrapper">
			...
			<div class="content_section">
				<div class="main_content">
					<h2 style="text-align:center;color:#9e005d;margin-top:15px;text-decoration:underline;">View All Categories Here</h2>
					<table border="1" width="600" align="center" style="margin:25px auto;text-align:center;">
						...
						<?php
							...
							<tr>
								<td><?php echo $i; ?></td>
								<td><?php echo $row['cat_title']."<br/>";?></td>
								<td><a href="cat_edit.php?edit_cat_id=<?php echo $row['cat_id'];?>" style="text-decoration:none;"><input type="button" value="Edit" style="background:#9e005d;color:white;padding:5px 10px;font-size:12px;"/></a></td>
								<td><a href="cat_delete.php?delete_cat_id=<?php echo $row['cat_id'];?>" style="text-decoration:none;"><input type="button" value="Delete" style="background:#9e005d;color:white;padding:5px 10px;font-size:12px;"/></a></td>
							</tr>
							<?php
							$i++;
							}
								...
								?>
									<tr>
										<td colspan="2" style="text-align:center;color:red;">There are no categories to view</td>
									</tr>
								<?php
							}
						?>
