...
$row = mysqli_fetch_array($run_query);
		...
		$row_cats = mysqli_fetch_array($query_cats);
				...
				<div class="main_content">
					<form action="" method="post" enctype="multipart/form-data">
						<table align="center" width="700"   style="color:#000;">
							...
							<tr align="center">
								<td colspan="2" style="padding:10px 0 20px 0;"><h1 style="color:#9e005d;text-decoration:underline;">Edit & Update Product</h1></b></td>
							</tr>
							
							<tr>
								<td align="right" style="color:#9e005d;"><b>Product Title:</b></td>
								<td><input type="text" name="product_title" size="60" value="<?php echo $product_title;?>" required/></td>
							</tr>
							
							<tr>
								<td align="right" style="color:#9e005d;"><b>Product Category:</b></td>
								<td>
							...
							<tr>
								<td align="right" style="color:#9e005d;"><b>Product Brand:</b></td>
								<td>
							...
							<tr>
								<td align="right" style="color:#9e005d;"><b>Product Image:</b></td>
								<td><input type="file" name="product_image" required /><img src="<?php echo $product_image;?>" height="50" width="50"/></td>
							</tr>
							
							<tr>
								<td align="right" style="color:#9e005d;"><b>Product Price:</b></td>
								<td><input type="text" name="product_price" size="60" value="<?php echo $product_price?>" required /></td>
							</tr>
							
							<tr>
								<td align="right" style="color:#9e005d;"><b>Product Description:</b></td>
								<td><textarea name="product_desc" cols="40" rows="10"><?php echo $product_desc;?></textarea></td>
							</tr>
							
							<tr>
								<td align="right" style="color:#9e005d;"><b>Product Keywords:</b></td>
								<td><input type="text" name="product_keywords" size="60" size="60" value="<?php echo $product_keywords;?>" required/></td>
							</tr>
							
							<tr align="center">
								<td colspan="2" style="padding:20px 0 20px 0;"><input type="submit" name="update_product" value="Update Product" size="60" required style="background:#9e005d;color:white;padding:5px 15px;font-size:16px;"/></b></td>
							</tr>
						</table>
					</form>
				</div>
...
<?php
	...
	if(isset($_POST['update_product'])){
		...
		$update_product = "update products set product_title='$product_title',product_cat='$product_cat',product_brand='$product_brand',product_image='$product_image',product_price='$product_price',product_desc='$product_desc',product_keywords='$product_keywords' where product_id='$update_product_id'";
